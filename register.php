...
<div class="auth-card">
    <div class="auth-grid">
        ...
        <div class="hero-section">
            ...
            <div class="hero-footer mt-12">
                <div class="flex items-center gap-4 mb-6">
                    ...
                    <div class="text-sm">
                        <div class="font-bold">5,000+ Users</div>
        ...
        <div class="form-section">
            <div class="tab-pill">
                <button class="tab-btn " id="loginTabBtn" onclick="switchTab('login')">Sign In</button>
                <button class="tab-btn active" id="registerTabBtn" onclick="switchTab('register')">New Account</button>
            </div>
            ...
            <div id="registerForm" style="display: none;">
                ...
                <form onsubmit="handleRegister(event)">
                    ...
                    <div class="input-group">
                        <i class="fas fa-lock"></i>
                        <input type="password" id="regPassword" placeholder="Create password" onkeyup="checkStrength(this.value)" >
                    ...
                    <div class="input-group mt-3">
                        ...
                        <input type="password" id="regConfirmPassword" placeholder="Confirm password" onkeyup="checkMatch()" >
                    </div>
...
<script>
    ...
    window.onload = () => switchTab('register');
</script>
</body>
</html>